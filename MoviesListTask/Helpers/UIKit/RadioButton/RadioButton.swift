...
@IBDesignable open class RadioButton: UIButton {
    ...
    /// - Note: This defaults to `true` just so that `onSelect` and `onDeselect` can add the gesture recognizer automatically,
    //but it is **not** added by default.
    ...
    private lazy var tapGesture: UITapGestureRecognizer = {
        ...
        tapg.addTarget(self, action: #selector(self.toggleState))
